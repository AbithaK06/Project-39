...
function draw() {
  ...
  text("LIFE: " + playCount, 100, windowHeight/2-30); 
}

function spawnClouds() {
  //write code here to spawn the clouds
  if (frameCount % 180 === 0) {
    var cloud = createSprite(windowWidth-50,height-300,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(windowWidth-50,height-95,10,40);
    //obstacle.debug = true;
